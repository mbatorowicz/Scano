...
- Zapisujemy obie strony kupującego: NABYWCA (płaci) i ODBIORCA (urząd, szkoła, jednostka). Szukasz obu bloków. Nie zamieniaj ich ze sobą ani ze sprzedawcą, nawet gdy nabywca jest wydrukowany wyżej.
- Danych z bloku ODBIORCA nie wpisujesz do pól nabywcy, nawet gdy odbiorca stoi obok i ma własny NIP. Odbiorcę wpisujesz wyłącznie do pól recipientName i recipientNip.
...
export const USER_MESSAGE =
  "Odczytaj dane z tej faktury. Zdjęcie może być krzywe albo pogniecione. Wpisz osobno NABYWCA i ODBIORCA — nie zamieniaj ich. Sprzedawca to Pecet.";
